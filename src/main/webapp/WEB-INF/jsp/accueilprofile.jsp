            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title font-16 mt-0">Accueil</h4>
                                <h6 class="card-subtitle font-14 text-muted">Gestion des entr&eacute;es</h6>
                            </div>
                            <img class="img-fluid"
                                 src="<c:url value='/images/icone_accueil.jpg' />"
                                 alt="Card image cap">
                            <div class="card-body">
                                <!--<p class="card-text">Some quick example text to build on the card title and make
                                    up the bulk of the card's content.</p>-->
                                <a href="ui-cards.html#" class="card-link">Acc&eacute;der</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title font-16 mt-0">Facturation</h4>
                                <h6 class="card-subtitle font-14 text-muted">Interface de paiement</h6>
                            </div>
                            <img class="img-fluid"
                                 src="<c:url value='/images/facturation.jpg' />"
                                 alt="Card image cap">
                            <div class="card-body">
                                <!--<p class="card-text">Some quick example text to build on the card title and make
                                    up the bulk of the card's content.</p>-->
                                <a href="/gestion/accfacturation" class="card-link">Acc&eacute;der</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title font-16 mt-0">Laboratoire</h4>
                                <h6 class="card-subtitle font-14 text-muted">Interface du labo</h6>
                            </div>
                            <img class="img-fluid"
                                 src="<c:url value='/images/laboratoire.jpg' />"
                                 alt="Card image cap">
                            <div class="card-body">
                                <!--<p class="card-text">Some quick example text to build on the card title and make
                                    up the bulk of the card's content.</p>-->
                                <a href="/gestion/acclaboratoire" class="card-link">Acc&eacute;der</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title font-16 mt-0">Pharmacie</h4>
                                <h6 class="card-subtitle font-14 text-muted">Gestion des ordonnances</h6>
                            </div>
                            <img class="img-fluid"
                                 src="<c:url value='/images/pharmacie.jpg' />"
                                 alt="Card image cap">
                            <div class="card-body">
                                <!--<p class="card-text">Some quick example text to build on the card title and make
                                    up the bulk of the card's content.</p>-->
                                <a href="/gestion/accpharmacie" class="card-link">Acc&eacute;der</a>
                            </div>
                        </div>
                    </div>
