                ...
                <ul class="metismenu" id="side-menu">
                    ...
                    <li>
                        <a href="javascript:void(0);"
                           class="waves-effect"><i class="fas fa-binoculars"></i>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $.get(monurl+"getpatientjour/"+medecinid,
            function(data) {
                //
                var tabLibelle = [];
                var tabTotal = [];
        ...
        // Catégorie d'age :
        $.get(monurl+"trancheagemedecin/"+medecinid,
            function(data) {
        ...
        //
        $.get(monurl+"getpatientgenre/"+medecinid,
            function(data) {
                var tabLibelle = [];
                var tabTotal = [];
