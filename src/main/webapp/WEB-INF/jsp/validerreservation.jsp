...
<head>
    ...
    <title>GestPAT - R&eacute;servation</title>
                ...
                <ul class="metismenu" id="side-menu">
                    ...
                    <li>
                        <a href="javascript:void(0);" class="waves-effect">
                            <i class="ti-email"></i>
                            <span> Menu <span class="float-right menu-arrow">
            ...
            <div class="container-fluid">
                <div class="page-title-box">
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <h4 class="page-title">Informations de la r&eacute;servation</h4>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="text-muted m-b-30 font-14">Informations relatives au patient</p>

                                <form id="form-horizontal" class="form-horizontal form-wizard-wrapper"
                                      action="${(!empty modification) ? modification : '/gestion/enregreservation'}"
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-lg-3 col-form-label">Membre</label>
                                                    <div class="col-lg-9">
                                                        <select id="idpaf" name="idpaf" class="form-control select2">
                                                            <option value="${membre.getIdpaf()}">
                                        ...
                                        <div class="row">
                                            <div id="infos" style="color:red;">${(!empty erreur) ? "Le solde du compte est insuffisant pour terminer la transaction !" : ""}</div>
                                        </div>
