               ...
               <div class="container-fluid">
                  <div class="page-title-box">
                     <div class="row align-items-center">
                        <div class="col-sm-6">
                           <h4 class="page-title">Gestion SERVICES</h4>
                        </div>
                     </div>
                  </div>
                  <!-- end row -->
                    	...
                    	<div class="card">
                    		<div class="card-body">
                    			...
                    			<form id="form-horizontal" class="form-horizontal form-wizard-wrapper"
                    			    action="${(!empty services) ? servicesid : '/gestion/creerservices'}"
                    			    method="POST"  >
                                        ...
                                        <div class="row">
                                        	<div class="col-md-6">
                                            	<div class="form-group row">
                                            		...
                                            		<div class="col-lg-9">
                                            			<input id="services" name="services" type="text"
                                            			value="${(!empty services) ? services.getLibelle() : ""}"
                                            			class="form-control" >
                                            		</div>
                                            	</div>
                                        	</div>
                                        ...
                                        <c:forEach var="service" items="${listeServices}">
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a title="Modifier" href="/gestion/modifservices/${service.getIdser()}" style="color: #78CBF5">
