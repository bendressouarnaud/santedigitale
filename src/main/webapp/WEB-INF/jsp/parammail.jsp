...
<head>
    ...
    <title>GestPAT - Param&eacute;trage</title>
                ...
                <ul class="metismenu" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            ...
                            <li><a href="/gestion/assignationpharm">Assignation pharmacien</a></li>
                            ...
                            <li><a href="/gestion/gestposologie">Gestion posologie</a></li>
                            <li><a href="/gestion/gestdosage">Gestion dosage</a></li>
                            <li><a href="/gestion/gesttypes">Gestion types</a></li>
            ...
            <div class="container-fluid">
                <div class="page-title-box">
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <h4 class="page-title">Param&egrave;tres</h4>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="text-muted m-b-30 font-14">Cat&eacute;gorie Utilisateur - Mail</p>

                                <form id="form-horizontal" class="form-horizontal form-wizard-wrapper"
                                      action="${(!empty modification) ? modification : '/gestion/enregparamail'}"
                                      method="POST">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-lg-3 col-form-label">S&eacute;cr&eacute;taire</label>
                                                    <div class="col-lg-9">
                                                        <select name="secretaire" class="form-control select2">
                                                            <option value="1" ${ (!empty parametrage) ? (parametrage.getEnvoimailsecretaire()==1) ? "selected" : "" : ""}>
                                                                Oui</option>
                                                            <option value="0" ${ (!empty parametrage) ? (parametrage.getEnvoimailsecretaire()==0) ? "selected" : "" : ""}>
                                                                Non</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-lg-3 col-form-label">Administrateur</label>
                                                    <div class="col-lg-9">
                                                        <select name="administrateur" class="form-control select2">
                                                            <option value="1" ${ (!empty parametrage) ? (parametrage.getEnvoimailadmin()==1) ? "selected" : "" : ""}>
                                                                Oui</option>
                                                            <option value="0" ${ (!empty parametrage) ? (parametrage.getEnvoimailadmin()==0) ? "selected" : "" : ""}>
                                                                Non</option>
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-lg-3 col-form-label">Gestionnaire</label>
                                                    <div class="col-lg-9">
                                                        <select name="gestionnaire" class="form-control select2">
                                                            <option value="1" ${ (!empty parametrage) ? (parametrage.getEnvoimailmanager()==1) ? "selected" : "" : ""}>
                                                                Oui</option>
                                                            <option value="0" ${ (!empty parametrage) ? (parametrage.getEnvoimailmanager()==0) ? "selected" : "" : ""}>
                                                                Non</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <select name="superadmin" class="form-control select2">
                                                            <option value="1" ${ (!empty parametrage) ? (parametrage.getEnvoimailsuperadmin()==1) ? "selected" : "" : ""}>
                                                                Oui</option>
                                                            <option value="0" ${ (!empty parametrage) ? (parametrage.getEnvoimailsuperadmin()==0) ? "selected" : "" : ""}>
                                                                Non</option>
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-lg-3 col-form-label">Laborantin</label>
                                                    <div class="col-lg-9">
                                                        <select name="laborantin" class="form-control select2">
                                                            <option value="1" ${ (!empty parametrage) ? (parametrage.getEnvoimaillaborantin()==1) ? "selected" : "" : ""}>
                                                                Oui</option>
                                                            <option value="0" ${ (!empty parametrage) ? (parametrage.getEnvoimaillaborantin()==0) ? "selected" : "" : ""}>
                                                                Non</option>
                                                        </select>
                                                    </div>
                                                </div>
