      ...
      <script>
            function alerter(valeur){
                ...
                document.getElementById("modifinfo").innerHTML =
                    "<a href='/gestion/supprimerhab/"+valeur+"' "+
               ...
               <div class="container-fluid">
                  <div class="page-title-box">
                     <div class="row align-items-center">
                        <div class="col-sm-6">
                           <h4 class="page-title">Gestion habilitation</h4>
                        </div>
                     </div>
                  </div>
                  <!-- end row -->
                    	...
                    	<div class="card">
                    		<div class="card-body">
                    			...
                    			<form id="form-horizontal" class="form-horizontal form-wizard-wrapper"
                    			    action="/gestion/enreghabilitation"
                    			    method="POST" >
							...
							<div class="modal-dialog modal-dialog-centered">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title mt-0">Supprimer cette habilitation ?</h5>
						...
						<div class="card">
                            ...
                            <!--  Diagnostic   -->
                                <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                    ...
                                    <tbody>
                                        <c:forEach var="habilitation" items="${listeDonnees}">
                                            <tr>
                                                <td>${habilitation[0]}</td>
                                                <td>
                                                    <a title="Supprimer" href="javascript:alerter(${habilitation[1]})" style="color: #78CBF5">
