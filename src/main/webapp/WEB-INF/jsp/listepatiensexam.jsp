                  ...
                  <div class="page-title-box">
                     <div class="row align-items-center">
                        <div class="col-sm-6">
                           ...
                           <ol class="breadcrumb">
                              <li class="breadcrumb-item active">des demandes des examens exprim&eacute;s aux patients </li>
                           </ol>
                        </div>
                     </div>
                  </div>
							...
							<div class="card-body">
								<table id="datatable" class="table table-bordered dt-responsive nowrap"
									...
									<tbody>
									    ...
									    <c:forEach var="donnee" items="${listepatient}">
                                            <tr>
                                                <td>${donnee[0]}</td>
                                                <td>${donnee[1]}</td>
                                                <td>${donnee[2]}</td>
                                                ...
                                                <td>${donnee[4]}</td>
                                                <td>
                                                    <a target="_blank" title="G&eacute;rer le bulletin d'examens"
                                                        href="/gestion/genererbulletinesp/${donnee[5]}" style="color: black">
