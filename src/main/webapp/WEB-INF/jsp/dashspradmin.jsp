...
<html lang="fr">
   <head>
      ...
      <title>GestPAT - Habilitation</title>
                  ...
                  <ul class="metismenu" id="side-menu">
                     ...
                     <li>
                        ...
                        <ul class="submenu">
                           ...
                           <!--<li><a href="/gestion/gestmixer">Mixer Fichier</a></li>-->
                           <li><a href="/gestion/deconnexion">D&eacute;connexion</a></li>
                        </ul>
                     </li>
                     <li>
                         <a href="javascript:void(0);" class="waves-effect"><i class="far fa-address-card"></i><span> Interfaces <span class="float-right menu-arrow"><i class="fas fa-angle-left"></i></span></span></a>
                         <ul class="submenu">
                             <li><a href="/gestion/gestservicesoption">Param&eacute;trer les services</a></li>
                             <li><a href="/gestion/parammail">Configuration user/mail</a></li>
                             <li><a href="/gestion/reachpharm">Pharmacies</a></li>
                         </ul>
                     </li>
                  </ul>
               </div>
               ...
               <div class="container-fluid">
                  <div class="page-title-box">
                     <div class="row align-items-center">
                        <div class="col-sm-6">
                           <h4 class="page-title">Gestion habilitations</h4>
                        </div>
                     </div>
                  </div>
                  <!-- end row -->
                    			...
                    			<form id="form-horizontal" class="form-horizontal form-wizard-wrapper"
                    				...
                    				<fieldset>
                                        ...
                                        <div class="row">
                                        	<div class="col-md-6">
                                        		<div class="form-group row">
                                        			<label class="col-lg-3 col-form-label">Rechercher Utilisateur</label>
                                        			<div class="col-lg-9">
                                        ...
                                        <div class="row">
                                        	<div class="col-md-6">
                                        		<div class="form-group row">
                                        			<label class="col-lg-3 col-form-label">Rechercher h&ocirc;pital</label>
                                        			<div class="col-lg-9">
                                        				<select name="hopital" class="form-control select2">
						...
						<div class="card">
                            ...
                            <!--  Diagnostic   -->
                                <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                    ...
                                    <tbody>
                                        <c:forEach var="habilitation" items="${listeHabilitation}">
                                            <tr>
                                                <td>${habilitation[0]}</td>
                                                <td>${habilitation[1]}</td>
                                                <td>
                                                    <a title="Modifier" href="/gestion/supprimeraut/${habilitation[2]}" style="color: #78CBF5">
