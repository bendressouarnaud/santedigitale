						...
						<div class="card">
							<div class="card-body">
								<table id="datatable" class="table table-bordered dt-responsive nowrap"
									...
									<tbody>
									    <c:forEach var="patient" items="${listePatientshab}">
                                            <tr>
                                                <td>${patient[1]}</td>
                                                <td>${patient[2]}</td>
                                                <td>${patient[3]}</td>
                                                ...
                                                <!--   afficherhistpatient    -->
                                                <td>
                                                    <a target="_blank" title="Produire le dossier m&eacute;dical"
                                                        href="/gestion/genererdossierpat/${patient[0]}" style="color: #78CBF5">
