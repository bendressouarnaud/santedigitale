...
<html lang="fr">
   <head>
      ...
      <title>GestPAT - Assignations</title>
               ...
               <div class="container-fluid">
                  <div class="page-title-box">
                     <div class="row align-items-center">
                        <div class="col-sm-6">
                           <h4 class="page-title">Gestion affectation service</h4>
                        </div>
                     </div>
                  </div>
                  <!-- end row -->
                    	...
                    	<div class="card">
                    		<div class="card-body">
                    			...
                    			<form id="form-horizontal" class="form-horizontal form-wizard-wrapper"
                    			    action="/gestion/enregaffservice"
                    			    method="POST" >
                                        ...
                                        <div class="row">
                                        	<div class="col-md-6">
                                        		<div class="form-group row">
                                        			...
                                        			<div class="col-lg-9">
                                        				<select name="idmed" class="form-control select2">
                                        	...
                                        	<div class="col-md-6">
                                        		<div class="form-group row">
                                        			<label class="col-lg-3 col-form-label">Rechercher Service</label>
                                        			<div class="col-lg-9">
                                        				<select name="idser" class="form-control select2">
						...
						<div class="card">
                            ...
                            <!--  Diagnostic   -->
                                <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                    ...
                                    <tbody>
                                        <c:forEach var="assignation" items="${listeAffectation}">
                                            <tr>
                                                <td>${assignation[0]}</td>
                                                <td>${assignation[1]}</td>
                                            </tr>
