                  ...
                  <div class="page-title-box">
                     <div class="row align-items-center">
                        <div class="col-sm-6">
                           ...
                           <ol class="breadcrumb">
                              <li class="breadcrumb-item active">&Eacute;volution des paiements par
                                propri&eacute;taire</li>
                           </ol>
                        </div>
                     </div>
                  </div>
						...
						<div class="card">
							<div class="card-body">
								<table id="datatable" class="table table-bordered dt-responsive nowrap"
									...
									<tbody>
									    <c:forEach var="liste" items="${listetendance}">
                                            <tr>
                                                <td>${liste[0]}</td>
                                                <td>${liste[1]}</td>
                                                <td>
                                                    <div class="progress">
                                                    	<div class="progress-bar" role="progressbar"
                                                    		style="width: ${liste[3]*8}%;" aria-valuenow="${liste[3]*8}"
                                                    		aria-valuemin="0"
                                                    		aria-valuemax="100">
                                                    		${liste[3]*8}%
                                                    	</div>
