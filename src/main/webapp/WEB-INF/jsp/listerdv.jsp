...
<html lang="fr">
   <head>
      ...
      <title>GestPAT | Liste des Rendez-Vous</title>
                  ...
                  <div class="page-title-box">
                     <div class="row align-items-center">
                        <div class="col-sm-3">
                           ...
                           <ol class="breadcrumb">
                              <li class="breadcrumb-item active">Liste des RDV</li>
                           </ol>
                        </div>

                        <div class="col-sm-9" style="text-align:right">
                            <img src="<c:url value='/images/rdvicone.png'/>"
						...
						<div class="card">
							<div class="card-body">
								<table id="datatable" class="table table-bordered dt-responsive nowrap"
									...
									<tbody>
									    <c:forEach var="patient" items="${listerdv}">
                                            <tr>
                                                <td>${patient[2]}</td>
                                                <td>${patient[3]}</td>
                                                <td>${patient[4]}</td>
