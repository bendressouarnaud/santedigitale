   ...
   <body>
	  ...
	  <script>
	    ...
	    $(document).ready(function(){
            ...
            $.get("http://www.gestdp.com/gestion/getpatientjour/"+medecinid,
                function(data) {
                    //
            ...
            $.get("http://www.gestdp.com/gestion/trancheagemedecin/"+medecinid,
                function(data) {
                    var j=0;
                    $(data).find('item').each(function(){
                        var tampon2 = {};
            ...
            $.get("http://www.gestdp.com/gestion/getpatientgenre/"+medecinid,
                function(data) {
                    var j=0;
                    $(data).find('item').each(function(){
                        var tampon2 = {};
