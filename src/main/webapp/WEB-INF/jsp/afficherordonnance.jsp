...
<html lang="fr">
   <head>
      ...
      <title>Accueil | Historique Ordonnance</title>
               ...
               <div id="sidebar-menu">
                  ...
                  <ul class="metismenu" id="side-menu">
                     ...
                     <li>
                        ...
                        <ul class="submenu">
                           <li><a href="/gestion/createordonnance/${idcont}">Nouvelle ordonnance</a></li>
                           <li><a href="/gestion/afficherhistpatient/${idpat}">Retour</a></li>
               ...
               <div class="container-fluid">
                  ...
                  <div class="page-title-box">
                     <div class="row align-items-center">
                        <div class="col-sm-6">
                           <h4 class="page-title">Historique ordonnances</h4>
                           <!--<ol class="breadcrumb">
							...
							<div class="card-body">
								<table id="datatable" class="table table-bordered dt-responsive nowrap"
									...
									<tbody>
									    ...
									    <c:forEach var="ordonnance" items="${listeordonnance}">
                                            <tr>
                                                <td>${ordonnance[0]}</td>
                                                <td>${ordonnance[1]}</td>
                                                <td>
                                                    <a target="_blank" title="G&eacute;n&eacute;rer l'ordonnance" target="_blank"
                                                       href="/gestion/genererordonnance/${ordonnance[1]}" style="color: #78CBF5">
                                                        <i class="far fa-address-card"></i>
                                                    </a>
                                                    &nbsp;&nbsp;&nbsp;
                                                    <a title="Modifier l'ordonnance" href="/gestion/modifierordonnance/${ordonnance[1]}" style="color: red">
                                                        <i class="fas fa-check-double"></i>
                                                    </a>

                                                    &nbsp;
                                                    <!-- Generate QrCode -->
                                                    <a title="G&eacute;n&eacute;rer le QRCODE" target="_blank"
                                                       href="/gestion/genererqrcode/${ordonnance[1]}" style="color: green">
