               ...
               <div id="sidebar-menu">
                  ...
                  <ul class="metismenu" id="side-menu">
                     <li>
                        ...
                        <ul class="submenu">
                           <li><a href="/gestion/creercommune">Ajouter commune</a></li>
         ...
         <div class="content-page">
            ...
            <div class="content">
               <div class="container-fluid">
                  ...
                  <c:if test="${(!empty commune) || (!empty creercommune)}">
                     <!--  ID et LIBELLE  -->
                     <form id="form-horizontal" class="form-horizontal form-wizard-wrapper"
                        action="${(!empty commune) ? '/gestion/editcom' : '/gestion/addcom'}" method="POST"
                        onsubmit="return desactiverId();">
                         ...
                         <div class="row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input id="id" name="id" disabled
                                          value="${(!empty commune) ? commune.getIdcom() : ""}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="libelle" class="col-lg-3 col-form-label">Libell&eacute;</label>
                                    <div class="col-lg-9">
                                        <input id="libelle" name="libelle" type="text"
                                        value="${(!empty commune) ? commune.getLibelle() : ""}"
                                        class="form-control">
                                    </div>
                                </div>
                            </div>
						...
						<div class="card">
							<div class="card-body">
								<table id="datatable" class="table table-bordered dt-responsive nowrap"
									...
									<tbody>
									    <c:forEach var="commune" items="${listecommune}">
                                            <tr>
                                                <td>${ commune.getLibelle() }</td>
                                                <td>
                                                    <a title="Modifier" href="/gestion/modifiercom/${commune.getIdcom()}" style="color: red">
