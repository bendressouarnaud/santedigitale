...
<head>
    ...
    <title>Accueil | Gestion des examens</title>
            ...
            <div class="container-fluid">
                <div class="page-title-box">
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <h4 class="page-title">R&eacute;sultats d'examens</h4>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active">
                                    Mise &agrave; jour des dossiers
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-6 col-md-6">
                        <div class="card directory-card">
                            <div class="card-body">
                                ...
                                <p class="mb-4" style="font-weight: bold">${(!empty patientJ) ? patientJ : "0"}</p>
                                <div class="clearfix"></div>
                                <hr>
                                <!--<p class="mb-0">&nbsp;</p>-->
                            </div>
                    ...
                    <div class="col-xl-6 col-md-6">
                        <div class="card directory-card">
                            <div class="card-body">
                                <div class="float-left mr-4">
                                    <img src="<c:url value='/images/analyselabo.jpg' />" alt=""
                                         class="img-fluid img-thumbnail rounded-circle thumb-lg">
                                </div>
                                <h5 class="text-primary font-18 mt-0 mb-1">Nombre d'examens journalier</h5>
                                <p class="font-12 mb-2">Proportion</p>
                                <p class="mb-4" style="font-weight: bold">${(!empty examenJ) ? examenJ : "0"}</p>
                                <div class="clearfix"></div>
                                <hr>
                                <!--<p class="mb-0">&nbsp;</p>-->
                            </div>
                                    ...
                                    <li class="nav-item" id="limotif">
                                        <a id="amotif" class="nav-link active" data-toggle="tab"
                                           href="#facturation" role="tab">
                                            ...
                                            <span class="d-none d-sm-block">Dossiers en attente</span>
                                        </a>
                                    </li><!--
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                                        ...
                                                        <c:forEach var="facture" items="${listepatients}">
                                                            <tr>
                                                                <td>${facture[0]}</td>
                                                                <td>${facture[1]}</td>
                                                                <td>${facture[2]}</td>
                                                                <td>${facture[4]}</td>
                                                                <td>
                                                                    <a title="Afficher l'historique" href="/gestion/modifexamfile/${facture[3]}" style="color: #db1637">
