            ...
            <div class="container-fluid">
                <div class="page-title-box">
                    <div class="row align-items-center">
                        <!--<div class="col-sm-6">   style="border:1px solid #0b2e13"-->
                        <div>
                            <h4 class="page-title"
                                style="float:left; margin-top: 15px">Gestion TYPE</h4>
                            &nbsp;&nbsp;&nbsp;<img src="<c:url value='/images/typeforme.jpg'/>"
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="form-horizontal" class="form-horizontal form-wizard-wrapper"
                                      action="/gestion/creertypesmedic"
                                      method="POST"  >
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                    ...
                                    <tbody>
                                    <c:forEach var="donnee" items="${liste}">
                                        <tr>
