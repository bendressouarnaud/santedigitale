            ...
            <div class="container-fluid">
                <div class="page-title-box">
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <h4 class="page-title">Gestion PHARMACIE</h4>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="form-horizontal" class="form-horizontal form-wizard-wrapper"
                                      action="${(!empty hopital) ? hopitalid : '/gestion/creerpharmc'}"
                                      method="POST"  >
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-lg-3 col-form-label">Num&eacute;ro</label>
                                                    <div class="col-lg-9">
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                    ...
                                    <c:forEach var="donnee" items="${liste}">
                                        <tr>
                                            ...
                                            <td>${donnee.getEmail()}</td>
                                            <td>${donnee.getNumero()}</td>
                                            <td>
