    ...
    <script>
        $(document).ready(function() {
            $().ready(function () {
                ...
                $.get(monurl+"getcalendriermedecinpat/"+medecinid,
                //$.get("http://localhost:8080/gestion/getcalendriermedecin/"+medecinid,
                    function(data) {
                        //
                        var patient = [];
                        var jour = [];
                ...
                $("#calendar").fullCalendar({
                    ...
                    events:[
                        {title:"Test R&eacute;union",start:new Date(n,a,t-7,10,30),allDay:!1}
                    ]
                });
                */
