            ...
            <div class="content">
               <div class="container-fluid">
                  ...
                  <form id="form-horizontal" class="form-horizontal form-wizard-wrapper"
                     action="${(!empty paiement) ? '/gestion/editpaie' : '/gestion/addpaie'}" method="POST"
                     onsubmit="return desactiverId();">
                      ...
                      <div class="row">
                             ...
                             <div class="form-group row">
                                 ...
                                 <div class="col-lg-9">
                                     <input id="id" name="id" disabled
                                       value="${(!empty paiement) ? paiement.getIdpaie() : ""}"
                         ...
                         <div class="col-md-6">
                             <div class="form-group row">
                                 <label for="priode" class="col-lg-3 col-form-label">P&eacute;riode</label>
                                 <div class="col-lg-9">
                                    <select name="priode" class="form-control select2">
                                        <c:forEach var="priode" items="${listeperiode}">
                                            <option
                                                value="${priode.getIdper()}"
                                                   ${(!empty paiement) ? paiement.getIdper()==priode.getIdper() ?
                                                    "selected"  : "" : ""}>
                                                ${priode.getLibelle()}
                                            </option>
                                        </c:forEach>
                      ...
                      <div class="row">
                             ...
                             <div class="form-group row">
                                 ...
                                 <div class="col-lg-9">
                                     <input id="montant" name="montant"
                                       value="${(!empty paiement) ? paiement.getMontant() : ""}"
                                     type="text" class="form-control" >
                                 </div>
                             </div>
                         </div>
                         ...
                         <div class="col-md-6">
                             <div class="form-group row">
                                 <label for="proprietaire" class="col-lg-3 col-form-label">Propri&eacute;taire</label>
                                 <div class="col-lg-9">
                                     <select name="proprietaire" class="form-control select2">
                                         <option value="${vendeuse.getIdven()}">
                                             ${vendeuse.getNom()}
                                         </option>
                                     </select>
                                 </div>
                      ...
                      <div class="row">
                         <div class="col-md-6">
                             <div class="form-group row">
                                 <label for="taxe" class="col-lg-3 col-form-label">Taxe</label>
                                 <div class="col-lg-9">
                                     <select name="taxe" class="form-control select2">
                                         <c:forEach var="txe" items="${listtaxes}">
                                             <option
                                                 value="${txe.getItaxe()}"
                                                    ${(!empty paiement) ? paiement.getItaxe()==txe.getItaxe() ?
                                                     "selected"  : "" : ""}>
                                                 ${txe.getLibelle()}
                                             </option>
                                         </c:forEach>
