               ...
               <div id="sidebar-menu">
                  ...
                  <ul class="metismenu" id="side-menu">
                     <li>
                        ...
                        <ul class="submenu">
                           <li><a href="/gestion/gestcommercante">Actualiser</a></li>
                           <li><a href="/gestion/creercommercante">Ajouter commercante</a></li>
                           <li><a href="/gestion/carte">Afficher commercante</a></li>
         ...
         <div class="content-page">
            ...
            <div class="content">
               <div class="container-fluid">
                  ...
                  <div class="page-title-box">
                     <div class="row align-items-center">
                        <div class="col-sm-6">
                           ...
                           <ol class="breadcrumb">
                              <li class="breadcrumb-item active">Gestion des commercantes</li>
                           </ol>
                        </div>
                     </div>
                  </div>
                  ...
                  <c:if test="${(!empty vendeuse) || (!empty creercommercante)}">
                     <!--  ID et LIBELLE  -->
                     <form id="form-horizontal" class="form-horizontal form-wizard-wrapper"
                        action="${(!empty vendeuse) ? '/gestion/editven' : '/gestion/addven'}" method="POST"
                        onsubmit="return desactiverId();">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input id="id" name="id" disabled
                                          value="${(!empty vendeuse) ? vendeuse.getIdven() : ""}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        value="${(!empty vendeuse) ? vendeuse.getNom() : ""}"
                                        class="form-control">
                                    </div>
                                </div>
                            </div>
                         ...
                         <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="contact" class="col-lg-3 col-form-label">Contact</label>
                                    <div class="col-lg-9">
                                        <input id="contact" name="contact"
                                          value="${(!empty vendeuse) ? vendeuse.getContact() : ""}"
                                        type="text" class="form-control" >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        value="${(!empty vendeuse) ? vendeuse.getEmail() : ""}"
                                        class="form-control">
                                    </div>
                                </div>
                            </div>
                         ...
                         <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="naissance" class="col-lg-3 col-form-label">Date naissance</label>
                                    <div class="col-lg-9">
                                        <input id="naissance" name="naissance"
                                          value="${(!empty vendeuse) ? daten : ""}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="piece" class="col-lg-3 col-form-label">Pi&egrave;ce identit&eacute;</label>
                                    <div class="col-lg-9">
                                        <input id="piece" name="piece" type="text"
                                        value="${(!empty vendeuse) ? vendeuse.getPieceidentite() : ""}"
                                        class="form-control">
                                    </div>
                                </div>
                            </div>
                         ...
                         <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="naissance" class="col-lg-3 col-form-label">March&eacute;</label>
                                    <div class="col-lg-9">
                                        <select name="marche" class="form-control select2">
                                            <c:forEach var="marche" items="${marches}">
                                                <option
                                                    value="${marche.getIdmar()}"
                                                       ${(!empty vendeuse) ? vendeuse.getIdmar()==marche.getIdmar() ? "selected"  : "" : ""}>
                                                    ${marche.getLibelle()}
                                                </option>
                                            </c:forEach>
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <select name="sexe" class="form-control select2">
                                            <option
                                                value="0"
                                                   ${(!empty vendeuse) ? vendeuse.getSexe()==0 ? "selected"  : "" : ""}>
                                                M
                                            </option>

                                            <option
                                                value="1"
                                                   ${(!empty vendeuse) ? vendeuse.getSexe()==1 ? "selected"  : "" : ""}>
                                                F
                                            </option>
                                        </select>
                                    </div>
						...
						<div class="card">
							<div class="card-body">
								<table id="datatable" class="table table-bordered dt-responsive nowrap"
									...
									<tbody>
									    <c:forEach var="vendeuse" items="${listevendeuse}">
                                            <tr>
                                                <td>${ vendeuse.getNom() }</td>
                                                <td>${ vendeuse.getContact() }</td>
                                                <td>${ vendeuse.getPieceidentite() }</td>
                                                <td>
                                                    <a title="Modifier" href="/gestion/modifierven/${vendeuse.getIdven()}" style="color: red">
