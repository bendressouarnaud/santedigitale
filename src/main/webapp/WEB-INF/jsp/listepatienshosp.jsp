                  ...
                  <div class="page-title-box">
                     <div class="row align-items-center">
                        <div class="col-sm-6">
                           ...
                           <ol class="breadcrumb">
                              <li class="breadcrumb-item active">des hospitalisations</li>
                           </ol>
                        </div>
                     </div>
                  </div>
									...
									<tbody>
									    ...
									    <c:forEach var="donnee" items="${listepatient}">
                                            <tr>
                                                ...
                                                <td>${donnee[7]}</td>
                                                <td>
                                                    <a target="_blank" title="G&eacute;r&eacute;rer l'avis d'hospitalisation"
                                                        href="/gestion/genereravishos/${donnee[8]}" style="color: #A68B6C">
