...
<head>
    ...
    <title>GestPAT - Assignations Pharmacies</title>
            ...
            <div class="container-fluid">
                <div class="page-title-box">
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <h4 class="page-title">Gestion assignation Pharmacie</h4>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="form-horizontal" class="form-horizontal form-wizard-wrapper"
                                      action="/gestion/enregassignationph"
                                      method="POST" >
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-lg-3 col-form-label">Rechercher Pharmacien</label>
                                                    <div class="col-lg-9">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-lg-3 col-form-label">Rechercher Pharmacie</label>
                                                    <div class="col-lg-9">
                                                        <select name="idpharm" class="form-control select2">
                                                            <c:forEach items="${listePharmacie}" var="pharmacie" >
                                                                <option value="${ pharmacie.getIdpharm() }">
                                                                        ${ pharmacie.getLibelle() }
                                                                </option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                    ...
                                    <tbody>
                                    <c:forEach var="assignation" items="${listeAssignation}">
                                        <tr>
                                            <td>${assignation[0]}</td>
                                            <td>${assignation[1]}</td>
                                        </tr>
