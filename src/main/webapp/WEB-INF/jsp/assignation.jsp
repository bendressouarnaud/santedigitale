...
<html lang="fr">
   <head>
      ...
      <title>GestPAT - Assignation</title>
               ...
               <div class="container-fluid">
                  <div class="page-title-box">
                     <div class="row align-items-center">
                        <div class="col-sm-6">
                           <h4 class="page-title">Gestion assignation</h4>
                        </div>
                     </div>
                  </div>
                  <!-- end row -->
                    	...
                    	<div class="card">
                    		<div class="card-body">
                    			...
                    			<form id="form-horizontal" class="form-horizontal form-wizard-wrapper"
                    			    action="/gestion/enregassignation"
                    			    method="POST" >
                                        ...
                                        <div class="row">
                                        	...
                                        	<div class="col-md-6">
                                        		<div class="form-group row">
                                        			...
                                        			<div class="col-lg-9">
                                        				<select name="idhopital" class="form-control select2">
