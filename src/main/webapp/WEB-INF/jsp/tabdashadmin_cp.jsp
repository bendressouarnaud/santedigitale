    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <!-- Frais de consultation / mois -->
                <div class="row">

                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="mt-0 header-title">Montant des consultations / mois</h4>
                                <!--<div class="ct-chart ct-golden-section">-->
                                <div class="card-body">
                                    <canvas id="montantmois" height="100" class="mypiechart"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="mt-0 header-title">Nombre de patients/m&eacute;decin (5 premiers)</h4>
                                <div class="ct-chart ct-golden-section">
                                    <!--<svg id="derniersmois" class="mypiechart"></svg>-->
                                    <canvas id="derniersmois" class="mypiechart"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="ct-chart ct-golden-section">
                                    ...
                                    <canvas id="test1" class="mypiechart"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        var tabCouleur = [];
        tabCouleur.push({couleur: 'rgb(255, 99, 132)'}); // red
        ...
        $.get(monurl+"getpatientmedecin/"+medecinid,
            function(data) {
                ...
                if(tabLibelle.length > 0) {
                    ...
                    //
                    var ctx = document.getElementById('derniersmois').getContext('2d');
                    new Chart(ctx, {
                        type: 'bar',
                        data: barChartData,
                        options: {
        ...
        $.get(monurl+"getmoismontant/"+medecinid,
            function(data) {
                ...
                if(tabLibelle.length > 0) {
                    ...
                    var barChartData = {
                        ...
                        datasets: [{
                            label: 'Montant',
                            backgroundColor: couleur(window.chartColors.greengrey).alpha(0.5).rgbString(),
                            borderColor: window.chartColors.greengrey,
                            borderWidth: 1,
                            data: tabTotal
                        }]
                    };
                    ...
                    //
                    var ctx = document.getElementById('montantmois').getContext('2d');
                    new Chart(ctx, {
                        type: 'bar',
                        data: barChartData,
                        options: {
