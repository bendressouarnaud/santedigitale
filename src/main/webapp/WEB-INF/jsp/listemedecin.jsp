...
<html lang="fr">
   <head>
      ...
      <title>GestPAT | Liste des med&eacute;cins</title>
                  ...
                  <div class="page-title-box">
                     <div class="row align-items-center">
                        <div class="col-sm-6">
                           ...
                           <ol class="breadcrumb">
                              <li class="breadcrumb-item active">Gestion des med&eacute;cins</li>
                           </ol>
                        </div>
                     </div>
                  </div>
							...
							<div class="card-body">
								<table id="datatable" class="table table-bordered dt-responsive nowrap"
									...
									<tbody>
									    ...
									    <c:forEach var="medecin" items="${listemedecin}">
                                            <tr>
                                                <td>${medecin[0]}</td>
                                                <td>${medecin[1]}</td>
                                                <td>${medecin[2]}</td>
                                                ...
                                                <td>${medecin[4]}</td>
                                                <td>
                                                    <a title="Afficher le tableau de bord"
                                                        href="#" style="color: #78CBF5">
